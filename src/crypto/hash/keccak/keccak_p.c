...
#define KECCAK_P_BODY(T, NROUND) do {			\
  ...
  Asu = state[24];					\
							\
  for (uint32_t round = 0; round < NROUND; round += 2) {\
    /* prepareTheta */					\
